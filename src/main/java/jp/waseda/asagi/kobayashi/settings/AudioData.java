...
public class AudioData {
  ...
  private static final int sampleSizeInBits = 8; // サンプルサイズ(8 or 16)
  private static final int channels = 1; // 音声のチャンネル数
  private static final boolean bigEndian = false; // ビッグエンディアンかどうか (データの送信方向。送受信間で統一されていれば問題ない)
